...
import { SocialNetworks, Character } from './aboutTemplate.styles';
import IconButton from '@/components/atoms/IconButton/IconButton';
import MediaButton from '@/components/atoms/MediaButton/MediaButton';

const AboutTemplate: FC = (): ReactElement => (
  <MainTemplate page="About">
    <Container>
      <Article>
        ...
        <br />
        <Columns columnsCount={4}>
          <Character imagePath="/static/images/about/team/aboutAgar3s">
            <img alt="Agar3s" />
            <h2>agar3s</h2>
            <p>
              co-founder
            ...
            <SocialNetworks>
              <MediaButton name="Twitter" imagePath="/static/images/about/team/media/Twitter.svg" href="#" />
              <MediaButton name="GitHub" imagePath="/static/images/about/team/media/GitHub.svg" href="#" />
              <MediaButton name="Itch.io" imagePath="/static/images/about/team/media/Itch.io.svg" href="#" />
            </SocialNetworks>
          </Character>
          <Character imagePath="/static/images/about/team/aboutMaikel">
            <img alt="Maikel" />
            <h2>maikel</h2>
            <p>
              co-founder
          ...
          <Character imagePath="/static/images/about/team/aboutYuel">
            <img alt="Yuel" />
            <h2>yuel</h2>
            <p>
              co-founder
            ...
            <SocialNetworks>
              <MediaButton name="Twitter" imagePath="/static/images/about/team/media/Twitter.svg" href="#" />
              <MediaButton name="Twitch" imagePath="/static/images/about/team/media/Twitch.svg" href="#" />
            </SocialNetworks>
          </Character>
          <Character imagePath="/static/images/about/team/aboutCarenalga">
            <img alt="Carenalga" />
            <h2>carenalga</h2>
            <p>
              co-founder
            ...
            <SocialNetworks>
              <MediaButton name="Twitter" imagePath="/static/images/about/team/media/Twitter.svg" href="#" />
              <MediaButton name="GitHub" imagePath="/static/images/about/team/media/Behance.svg" href="#" />
              <MediaButton name="Itch.io" imagePath="/static/images/about/team/media/Itch.io.svg" href="#" />
            </SocialNetworks>
          </Character>
        </Columns>
